		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					<!-- Logo-->
					<div class="logo">
						<a href="home.html"> <img src="${URL}assets/images/logo.png"
							alt="logo">
						</a>
					</div>
					<!-- End logo -->
					...
					<div class="navbar-collapse collapse"
						...
						<div class="nav-outer">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown hidden-sm"><a href="category.html">News<span
										class="menu-label new-menu hidden-xs">new</span>
								</a></li>
								<li class="dropdown"><a href="contact.html">About us</a></li>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-hover="dropdown" data-toggle="dropdown">Categories</a>
								...
								<li class="dropdown hidden-sm"><a href="category.html">Forum</a>
								</li>
								<li class="dropdown"><a href="contact.html">Contact</a></li>

								<li class="dropdown  navbar-right special-menu"><a href="#">Get
										30% off on selected items</a></li>
							</ul>
							<div class="clearfix"></div>
						</div>
					</div>
