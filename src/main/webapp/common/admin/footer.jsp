							...
							<ul class="toggle-footer" style="">
								<li class="media">
									...
									<div class="media-body">
										<p>!st Vo Van Ngan St., Thu Duc , Ho Chi Minh City, Viet
											Nam</p>
									</div>
								</li>
								<li class="media">
								...
								<li class="media">
									...
									<div class="media-body">
										<span><a href="#">work.xuanbao@gmail.com</a></span>
									</div>
								</li>
							</ul>
						</div>
		...
		<div class="container">
			...
			<div class="col-xs-12 col-sm-4 no-padding">
				<div class="clearfix payment-methods">
					<ul>
						<li><img src="${URL}assets/images/payments/1.png" alt=""></li>
						<li><img src="${URL}assets/images/payments/2.png" alt=""></li>
						<li><img src="${URL}assets/images/payments/3.png" alt=""></li>
						<li><img src="${URL}assets/images/payments/4.png" alt=""></li>
						<li><img src="${URL}assets/images/payments/5.png" alt=""></li>
					</ul>
				</div>
			</div>
		</div>
