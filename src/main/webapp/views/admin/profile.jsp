		...
		<div class="sign-in-page">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 create-new-account">
					<h1 class="checkout-subtitle">Modify Account</h1>
					...
					<form action="${pageContext.request.contextPath }/admin/profile"
						...
						<div class="form-group">
							...
							</label> <input type="radio" id="stmale" name="gender" value="Male"
								<c:if test="${sessionScope.account.gender == 'Male' }">checked</c:if>>
							<label for="stmale"> Male</label> <br> <input type="radio"
								id="stfemale" name="gender" value="Female"
								<c:if test="${sessionScope.account.gender == 'Female' }">checked</c:if>>
